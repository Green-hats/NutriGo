...
func setupTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.User{}, &model.FoodDiary{}, &model.DietBatch{}, &model.DailySummary{}, &model.UserProfile{}, &model.FoodImage{}, &model.RefreshToken{}, &model.BlacklistedToken{}); err != nil {
		t.Fatalf("建表失败: %v", err)
	}
	return db
}
