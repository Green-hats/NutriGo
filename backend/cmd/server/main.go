...
func main() {
	...
	// 自动建表
	if err := config.DB.AutoMigrate(&model.User{}, &model.UserProfile{}, &model.FoodImage{}, &model.ImageDeletion{}, &model.FoodDiary{}, &model.DietBatch{}, &model.DailySummary{}, &model.RefreshToken{}, &model.BlacklistedToken{}); err != nil {
