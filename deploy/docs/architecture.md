# NutriGo 旧版网页部署架构（历史参考）

当前产品已迁移为 Tauri 2 手机 App + 单机云端 API。最新架构图及 DeepSeek 照片分析流程见 [架构设计](../../docs/ARCHITECTURE.md)，当前部署入口见 [cloud/README.md](../cloud/README.md)。以下保留旧网页部署拓扑，供已有部署迁移时参考。
